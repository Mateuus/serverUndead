...
CSupervisorConfig::CSupervisorConfig()
{
  ...
  webAPIDomainIP_ = r3dReadCFG_S(configFile, group, "webAPIDomainIP", "198.50.211.32");
  webAPIDomainBaseURL_ = r3dReadCFG_S(configFile, group, "webAPIDomainBaseURL", "/conection/api/");
